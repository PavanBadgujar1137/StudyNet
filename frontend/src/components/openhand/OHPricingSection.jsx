  ...
  const learnerPlans = [
    {
      ...
      badge: "ESSENTIAL LEARNER MEMBERSHIP",
      featured: false,
      features: [
    ...
    },
    {
      ...
      badge: "ULTIMATE WELLBEING COVERAGE",
      featured: false,
      features: [
  ...
  const practitionerPlans = [
    {
      ...
      badge: "PRACTITIONER PLATFORM UNLOCK",
      featured: false,
      features: [
    ...
    },
    {
      ...
      badge: "CLINIC & VIP PRACTITIONERS",
      featured: false,
      features: [
        "Everything in Growth Plan",
        "Zero commission options on high-volume session bookings",
        "White-label client portal & custom domain support",
        "Dedicated account manager & priority 24/7 support",
        "Full cohort analytics & client retention intelligence",
        "Multi-practitioner team support & revenue splitting",
      ],
    },
  ]
